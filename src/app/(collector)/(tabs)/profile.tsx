  ...
  const sections: { title?: string; items: MenuItem[] }[] = [
    {
      ...
      items: [
        { label: 'Nouveau dépôt',   icon: '💰', onPress: () => router.push('/(collector)/deposits/new' as any) },
        { label: 'Retraits',        icon: '💸', onPress: () => router.push('/(collector)/(tabs)/withdrawals' as any) },
        { label: 'Prêts',           icon: '💳', onPress: () => router.push('/(collector)/(tabs)/loans' as any) },
      ],
    },
    {
      title: 'Informations',
