  ...
  return (
    <View style={styles.root}>
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        ...
        <Text style={styles.headerTitle}>Retraits à décaisser</Text>
        <View style={{ width: 38 }} />
      </View>
            ...
            {approved.length === 0 ? (
              ...
              approved.map((txn, i) => (
                <WithdrawalRow
                  ...
                  action={{ label: 'Décaisser', onPress: () => handleDisburse(txn), loading: disbursing === txn.id }}
                />
              ))
            )}
          </View>
  ...
  return (
    <View style={[styles.row, !last && styles.rowBorder]}>
      ...
      <View style={{ alignItems: 'flex-end', gap: 6 }}>
        ...
        {action && (
          <TouchableOpacity
            style={[styles.actionBtn, action.loading && styles.actionBtnLoading]}
...
const styles = StyleSheet.create({
  ...
  actionBtn: { backgroundColor: Colors.primary, borderRadius: 8, paddingHorizontal: Spacing.two, paddingVertical: 6 },
