...
import { getAdminNotifications, type AdminNotification } from '@/services/admin';
          ...
          renderItem={({ item }) => (
            <View style={[styles.card, !item.read && styles.cardUnread]}>
              ...
              <View style={{ flex: 1 }}>
                ...
                {item.body ? <Text style={styles.notifBody} numberOfLines={3}>{item.body}</Text> : null}
                <Text style={styles.notifDate}>{new Date(item.created_at).toLocaleDateString('fr-CD', {
