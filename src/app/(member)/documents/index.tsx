...
const styles = StyleSheet.create({
  ...
  uploadLabel: { fontFamily: Fonts.semiBold, fontSize: 13, color: Colors.white },
  ...
  emptyBtnLabel: { fontFamily: Fonts.semiBold, fontSize: 14, color: Colors.white },
});
